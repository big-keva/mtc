...
TestItEasy::RegisterFunc  testPatricia( []()
{
  ...
  TEST_CASE( "patricia keys are deleteable" )
  {
    SECTION( "one-range keys may be deleted" )
    {
      ...
      REQUIRE( patree.Delete( "bbb" ) );
      REQUIRE( patree.Delete( std::string( "ccc" ) ) );
      REQUIRE( patree.Delete( "aaa" ) );
    }
    ...
    SECTION( "partial keys may be deleted upper-to-lower" )
    {
      ...
      REQUIRE(  patree.Insert( std::string( "a" ), 1 ) != nullptr );
      REQUIRE( *patree.Insert( std::string( "aa" ), 11 ) == 11 );

      REQUIRE( patree.Delete( "aa" ) );
      REQUIRE( patree.Delete( std::string( "a" ) ) );

      REQUIRE( patree.empty() );
    }
    ...
    SECTION( "partial keys may be deleted with merging" )
    {
      ...
      REQUIRE( patree.Delete( "aa" ) );
      REQUIRE( patree.Search( "a" ) != nullptr );
      REQUIRE( patree.Search( "aa" ) == nullptr );
      REQUIRE( patree.Search( "aaa" ) != nullptr );

      REQUIRE( patree.Delete( "a" ) );
      REQUIRE( patree.Search( "aaa" ) != nullptr );
  ...
  TEST_CASE( "patricia::tree is iterable" )
  {
    ...
    SECTION( "deleted elements do not affect the iterator" )
    {
      patree.Insert( "a", 1 );
      patree.Insert( "aa", 11 );
      patree.Insert( "aaa", 111 );
      patree.Insert( "bbb", 222 );
