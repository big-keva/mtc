...
TestItEasy::RegisterFunc  testPatricia( []
  {
    TEST_CASE( "mtc/patricia" )
    {
      SECTION( "patricia keys are deletable" )
      {
    ...
    SECTION( "patricia::tree is dynamic" )
    {
      mtc::patricia::tree<int>  patree;
    ...
    SECTION( "patricia::tree is iterable" )
    {
      mtc::patricia::tree<int>  patree;
    ...
    SECTION( "patricia::tree is serializable" )
    {
      mtc::patricia::tree<int>  patree;
